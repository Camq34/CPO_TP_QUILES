...
Cadena_code jeu;
    ...
    private void initComponents() {
        ...
        texte_intro.setFont(new java.awt.Font("Trebuchet MS", 0, 24)); // NOI18N
        texte_intro.setForeground(new java.awt.Color(153, 0, 153));
        texte_intro.setText("C'est parti !");
        getContentPane().add(texte_intro, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 200, 30));
